  ...
  const features = [
    {
      icon: "🎯",
      title: "Умные Вопросы",
      description: "Автоматически генерируемые вопросы на основе технологий и уровня сложности. Адаптивная система подбора заданий."
    },
    {
      icon: "📊",
      title: "Аналитика",
      description: "Подробная статистика по результатам собеседований. Отслеживайте прогресс и выявляйте области для улучшения."
    },
    {
      icon: "⚡",
      title: "Быстрый Старт",
      description: "Начните собеседование за несколько кликов. Интуитивный интерфейс и готовые шаблоны для разных ролей."
    }
  ];
